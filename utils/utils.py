...
def load_loggers(cfg):
    ...
    cfg.log_path = Path(log_path) / log_name / version_name / f'fold{cfg.Data.fold}-train{cfg.Data.type}'
    print(f'---->Log dir: {cfg.log_path}')
    
    #---->TensorBoard
    tb_logger = pl_loggers.TensorBoardLogger(log_path+str(log_name),
                                             name = version_name, version = f'fold{cfg.Data.fold}-train{cfg.Data.type}',
